...
export const GET: APIRoute = () => {
  ...
  lines.push(`- [Photography Studios with Infinity Coves in Berlin](${base}/blog/studios-with-infinity-coves-berlin/): ${coveCount} studios with infinity coves.`);
  lines.push('');
  lines.push('## Data');
